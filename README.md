...
・新規登録機能  
ニックネーム、メールアドレス、パスワードを入力して新規登録できる  
・ログイン機能  
メールアドレス、パスワードを入力して、ログインできる  
・投稿機能  
レシピ名、材料、作り方、画像（ない場合はno-imageの画像になる）を入力して投稿できる  
・編集機能  
 投稿したレシピを編集することができる  
[![Image from Gyazo](https://i.gyazo.com/f9b36fc285a78e3b466708fe04a16951.gif)](https://gyazo.com/f9b36fc285a78e3b466708fe04a16951)  
・削除機能  
不要になったレシピを削除することができる  
・検索機能  
タイトルのキーワードを入力すると検索することができる  
[![Image from Gyazo](https://i.gyazo.com/22c9c03ae4d82fc497fdc4d517eb6a82.gif)](https://gyazo.com/22c9c03ae4d82fc497fdc4d517eb6a82)  
